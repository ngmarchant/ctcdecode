...
class DecoderState {
  ...
  std::vector<std::vector<PathTrie *>> groups;
  std::vector<PathTrie *> roots;
...
public:
  ...
  */
  ...
  void beam_step(const std::vector<std::vector<double>> &probs_seq, size_t time_step, size_t group);
};
