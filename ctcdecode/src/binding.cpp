                ...
                at::Tensor th_out_length)
{
    ...
    ctc_beam_search_decoder_batch(inputs, new_vocab, beam_size, num_processes, cutoff_prob, cutoff_top_n, blank_id, sil_id, log_input, ext_scorer, num_groups, diversity_factor);
...
int paddle_beam_decode(at::Tensor th_probs,
    ...
    return beam_decode(th_probs, th_seq_lens, labels, vocab_size, beam_size, num_processes, num_groups,diversity_factor,
                cutoff_prob, cutoff_top_n, blank_id, sil_id, log_input, NULL, th_output, th_timesteps, th_scores, th_out_length);
}
...
int paddle_beam_decode_lm(at::Tensor th_probs,
    ...
    return beam_decode(th_probs, th_seq_lens, labels, vocab_size, beam_size, num_processes, num_groups,diversity_factor,
                cutoff_prob, cutoff_top_n, blank_id, sil_id, log_input, scorer, th_output, th_timesteps, th_scores, th_out_length);
}
